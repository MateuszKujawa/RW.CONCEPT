function xData() {
    const posts = [
        {
            linkToNewsPage: "./pages/news.html#news1",
        ...
        {
            image: "./images/img/news/kino.jpg",
            title: "R/W Concept - Otwarcie kina samochodowego.",
            description: "Kino samochodowe zostało otwarte! Wszystkich miłośników kina i samochodów serdecznie zapraszamy!",
        },
        {
            image: "./images/img/news/tor.jpg",
            title: "Ruszył tor wyścigowy R/W Concept w Słupcy!",
            description: "W tym tygodniu uruchomiony został tor wyścigowy do szkolenia i doskonalenia swoich umiejętności prowadzenia samochodu!",
        }
    ];
